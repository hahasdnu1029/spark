 ...
 */
case class CreateStruct2(children: Seq[Expression]) extends Expression {
 ...
 */
case class CreateNamedStruct2(children: Seq[Expression]) extends Expression {
 ...
 */
case class CreateStructUnsafe2(children: Seq[Expression]) extends Expression {
  ...
  override def doGenCode(ctx: CodegenContext, ev: ExprCode): ExprCode = {
    ...
    ExprCode(eval.code,eval.isNull,eval.value)
  }
 ...
 * @param children Seq(name1, val1, name2, val2, ...)
 */
case class CreateNamedStructUnsafe2(children: Seq[Expression]) extends Expression {
